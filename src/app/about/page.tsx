...
const heroGrid: [ServiceHeroGridCell, ServiceHeroGridCell, ServiceHeroGridCell, ServiceHeroGridCell] = [
  ...
  {
    src: "/portfolio/jewellery/01.webp",
    alt: "Sovereign jewellery festive campaign creative",
  ...
  },
  {
    ...
    alt: "Chola MS Health Insurance print advertising campaign creative",
    badgeLabel: "Brand Campaigns",
    badgeIcon: "media",
  },
];
