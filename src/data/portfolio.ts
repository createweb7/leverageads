...
export const portfolioItems: PortfolioItem[] = [
  ...
  { src: "/portfolio/logo-identity/07-gds-agro-promoter.webp", alt: "GDS Agro Promoter India brand identity and stationery", categorySlug: "logo-identity", width: 1078, height: 1600 },
  { src: "/portfolio/logo-identity/08-akshara-gifts.webp", alt: "Akshara Gifts brand identity and stationery", categorySlug: "logo-identity", width: 1078, height: 1600 },
  { src: "/portfolio/logo-identity/09-shifa-hospital.webp", alt: "Shifa Hospital and Research Centre — Dr. Asra Khan brand identity and business card", categorySlug: "logo-identity", width: 1078, height: 1600 },
  { src: "/portfolio/logo-identity/10-big-tree-import-export.webp", alt: "Big Tree Import and Export brand identity and stationery", categorySlug: "logo-identity", width: 1078, height: 1600 },
  { src: "/portfolio/logo-identity/11-challani-jewellery-mart-2.webp", alt: "Challani Jewellery Mart brand identity and stationery", categorySlug: "logo-identity", width: 1078, height: 1600 },
  { src: "/portfolio/logo-identity/12-cooltrip-india.webp", alt: "CoolTrip India brand identity and stationery", categorySlug: "logo-identity", width: 1078, height: 1600 },
  { src: "/portfolio/logo-identity/13-mindframe-media.webp", alt: "Mindframe Media Ltd (MFM) brand identity and stationery", categorySlug: "logo-identity", width: 1078, height: 1600 },
  { src: "/portfolio/logo-identity/14-nidhish-krishnaa-foundation.webp", alt: "Nidhish Krishnaa Foundation brand identity and stationery", categorySlug: "logo-identity", width: 1078, height: 1600 },
  { src: "/portfolio/logo-identity/15-bonjour-bonheur.webp", alt: "Bonjour Bonheur travel brand identity and stationery", categorySlug: "logo-identity", width: 1078, height: 1600 },
  { src: "/portfolio/logo-identity/16-icorrpro-projects.webp", alt: "ICORRPRO Projects India brand identity and stationery", categorySlug: "logo-identity", width: 1078, height: 1600 },
  { src: "/portfolio/logo-identity/17-st-pauls-school.webp", alt: "St. Paul's Matriculation Higher Secondary School brand identity and stationery", categorySlug: "logo-identity", width: 1079, height: 1600 },
  { src: "/portfolio/logo-identity/18-tejaas-hallmarking.webp", alt: "Tejaas Hallmarking brand identity and stationery", categorySlug: "logo-identity", width: 1078, height: 1600 },
  { src: "/portfolio/logo-identity/19-surbharti-sangeet-vidyalaya.webp", alt: "Surbharti Hindustani Classical Sangeet Vidyalaya brand identity and stationery", categorySlug: "logo-identity", width: 1079, height: 1600 },
  { src: "/portfolio/logo-identity/20-metamorphosis-learning-institute.webp", alt: "Metamorphosis Learning Institute brand identity and stationery", categorySlug: "logo-identity", width: 1078, height: 1600 },
  { src: "/portfolio/logo-identity/21-akshara-vidyaashram.webp", alt: "Akshara Vidyaashram brand identity and stationery", categorySlug: "logo-identity", width: 1080, height: 1600 },
  ...
  { src: "/portfolio/packaging/08-dew-creatine-ethyl-ester.webp", alt: "DEW D' Creatine Ethyl Ester supplement jar packaging design", categorySlug: "packaging", width: 1260, height: 1600 },
  { src: "/portfolio/packaging/09-dew-creatru.webp", alt: "DEW CREATRU creatine monohydrate jar packaging design", categorySlug: "packaging", width: 1260, height: 1600 },
  { src: "/portfolio/packaging/10-dew-tri-creatine-malate.webp", alt: "DEW D' Tri Creatine Malate supplement jar packaging design", categorySlug: "packaging", width: 1260, height: 1600 },
  { src: "/portfolio/packaging/11-dew-l-glutamine.webp", alt: "DEW D' L-Glutamine supplement jar packaging design", categorySlug: "packaging", width: 1260, height: 1600 },
  { src: "/portfolio/packaging/12-emg-united-memory-card.webp", alt: "EMG United E-Tron micro SDHC memory card blister packaging design", categorySlug: "packaging", width: 1245, height: 1600 },
  { src: "/portfolio/packaging/13-osteokare-label.webp", alt: "Rheno Osteokare nutritional supplement jar label design", categorySlug: "packaging", width: 1600, height: 369 },
  { src: "/portfolio/packaging/14-relishpro-hot-chocolate.webp", alt: "Relishpro hot chocolate jar packaging photography", categorySlug: "packaging", width: 1600, height: 1054 },
  { src: "/portfolio/packaging/15-dakshin-kitchen-box-2.webp", alt: "Dakshin Kitchen South Indian restaurant food box packaging design", categorySlug: "packaging", width: 1600, height: 1249 },
  { src: "/portfolio/packaging/16-mpr-idli-dosa-maavu.webp", alt: "MPR Maavu idli and dosa batter mix pouch packaging design", categorySlug: "packaging", width: 1600, height: 916 },
  { src: "/portfolio/packaging/17-mpr-chettinad-chutney.webp", alt: "MPR Foods Chettinad Milagai Chutney pouch packaging design", categorySlug: "packaging", width: 1600, height: 1102 },
  { src: "/portfolio/packaging/18-lakshmi-jewellery-torch-gift.webp", alt: "Pondicherry Sri Lakshmi Jewelery 5 LED rechargeable torch gift box packaging design", categorySlug: "packaging", width: 1600, height: 1280 },
  { src: "/portfolio/packaging/19-challani-calendar-box.webp", alt: "Challani Jewellery Mart calendar box packaging design", categorySlug: "packaging", width: 1600, height: 896 },
  { src: "/portfolio/packaging/20-ultra-aqua-water-bottle.webp", alt: "Pure Ultra Aqua steel water bottle packaging design", categorySlug: "packaging", width: 1132, height: 1600 },
