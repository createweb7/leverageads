...
export const services: ServicePage[] = [
  {
    ...
    included: [
      ...
      {
        title: "Sales & Business Campaigns",
        items: [
  ...
  },
  {
    ...
    included: [
      ...
      {
        title: "Reputation, Analytics & Growth",
        items: [
          "Online Reputation Management (ORM)",
          "Google Analytics (GA4) & Tag Manager",
          "Conversion Rate Optimisation (CRO)",
          "Digital Brand Strategy",
          "Digital Audits & Growth Consultancy",
        ],
      },
    ],
    faqs: [
  ...
  },
  {
    ...
    included: [
      ...
      {
        title: "UI/UX Design",
        items: ["User Research", "Wireframes", "Interactive Prototypes", "Dashboard Design", "Design Systems"],
      },
      {
      ...
      },
      {
        ...
        items: ["Android Apps", "iOS Apps", "Hybrid Apps", "Enterprise Mobility Solutions"],
      },
      {
        title: "ERP Solutions",
        items: [
          "ERP Consultation & Implementation",
          "ERP Design, Development & Customisation",
          "Cloud ERP Solutions",
          "Manufacturing, Retail, Educational & Hospitality ERP",
          "Inventory, HR & Payroll, Finance & Accounting Modules",
        ],
      },
      {
        title: "CRM Solutions",
      ...
      },
      {
        ...
        items: [
          ...
          "Approval Workflows & Digital Forms",
          "Process Automation",
        ],
      },
      {
        title: "AI Solutions",
        items: ["AI Chatbots", "AI Customer Support", "AI Content Solutions", "AI Workflow Automation"],
      },
      {
        title: "WhatsApp Business Solutions",
        items: ["WhatsApp Business API", "Chatbot Development", "Automated Customer Support"],
      },
      {
  ...
  },
  {
    ...
    images: [
      { src: "/portfolio/media-planning/01-hoarding-40x40-rajendiras.webp", alt: "Rajendira's Women's Store 40x40 outdoor hoarding campaign", width: 1600, height: 1600 },
      { src: "/portfolio/media-planning/06-full-page-press-tamil.webp", alt: "Rajendira's Women's Store full-page Tamil press advertisement", width: 762, height: 1200 },
    ],
    heroGrid: [
      {
        src: "/portfolio/media-planning/01-hoarding-40x40-rajendiras.webp",
        alt: "Rajendira's Women's Store \"What Women Want\" 40x40 outdoor hoarding campaign",
        badgeLabel: "Outdoor Advertising",
        badgeIcon: "media",
      },
      {
        src: "/portfolio/media-planning/02-hoarding-3x3-banner.webp",
        alt: "Rajendira's Women's Store outdoor banner campaign",
        badgeLabel: "100+ · Brands Reached",
        badgeVariant: "dark",
      },
      {
        src: "/portfolio/media-planning/05-magazine-advt-a5.webp",
        alt: "Rajendira's Women's Store A5 magazine advertisement",
        badgeLabel: "Print & Magazine",
        badgeIcon: "media",
      },
      {
        src: "/portfolio/media-planning/09-brochure-front-mens-womens.webp",
        alt: "Rajendira's Men's Store and Women's Store brochure",
  ...
  },
  {
    ...
    heroGrid: [
      ...
      },
      {
        ...
        badgeLabel: "Communication & Interpersonal Skills",
        badgeIcon: "media",
      },
    ],
  },
